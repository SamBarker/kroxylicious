...
public final class MessageUtil {
    ...
    // TODO #4578: remove once message generator produces io.kroxylicious.kafka.common.message.*
    public static ByteBufferAccessor toByteBufferAccessor(final org.apache.kafka.common.protocol.Message message, final short version) {
