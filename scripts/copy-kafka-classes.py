...
FILES = [
    ...
    # ControlRecordUtils / EndTransactionMarker: copied; their org.apache.kafka.common.message.* imports
    # kept as org.apache.kafka.* until message generator produces io.kroxylicious.kafka.common.message.* (issue #4644).
    # MemoryRecordsBuilder: same TODO pattern; all methods retained.
    ...
    ("common/record/internal/ControlRecordUtils.java",        "common/record/internal/ControlRecordUtils.java"),
    ("common/record/internal/EndTransactionMarker.java",      "common/record/internal/EndTransactionMarker.java"),
    ("common/record/internal/MemoryRecordsBuilder.java",      "common/record/internal/MemoryRecordsBuilder.java"),
...
IMPORT_PREFIXES = [
    ...
    # Utils and Compression remain as org.apache.kafka.* (both are in kafka-clients).
    # TODO #4578: rewrite to io.kroxylicious.kafka.* once those classes are copied/created.
